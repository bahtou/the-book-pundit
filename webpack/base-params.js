...
module.exports = {
  ...
  jsPaths: [
    ...
    path.resolve(__dirname, '..', `${appRoot}/components`),
    path.resolve(__dirname, '..', `${appRoot}/contexts`),
    ...
    path.resolve(__dirname, '..', `${appRoot}/registerServiceWorker.js`),
    path.resolve(__dirname, '..', `${appRoot}/pipeline`),
    path.resolve(__dirname, '..', `${appRoot}/services`),
    path.resolve(__dirname, '..', `${appRoot}/shared`),
    path.resolve(__dirname, '..', `${appRoot}/utils`)
  ],
  ...
  resolveAliasPaths: {
    ...
    Actions: path.resolve(__dirname, '..', `${appRoot}/actions`),
    Components: path.resolve(__dirname, '..', `${appRoot}/components`),
    Contexts: path.resolve(__dirname, '..', `${appRoot}/contexts`),
    ...
    Sagas: path.resolve(__dirname, '..', `${appRoot}/sagas`),
    ...
    Vendors: path.resolve(__dirname, '..', `${appRoot}/assets/vendors`)
  },
